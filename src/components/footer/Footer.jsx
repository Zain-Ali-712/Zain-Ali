        ...
        <footer>
            ...
            <div className="footer-primary">
                <div className="footer-left">
                    <img src="/Z.png" alt="Zain Ali Logo" />
                </div>
                <div className="footer-right">
                    ...
                    <div className="footer-contact">
                        ...
                        <div className="social-icons">
                            <a href="https://www.linkedin.com/in/zain-webdev-68ba04365?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app" target="_blank" rel="noopener noreferrer"><FaLinkedinIn /></a>
                            <a href="https://www.instagram.com/zaindev_design?igsh=ZGdzZzdnd3Uwcnkw" target="_blank" rel="noopener noreferrer"><FaInstagram /></a>
                            <a href="https://github.com/Zain-Ali-712" target="_blank" rel="noopener noreferrer"><FaGithub /></a>
                        </div>
                    </div>
                </div>
            </div>
